  ...
  <div class="col-12 w-auto table-fixed">
    <div class="card">
      ...
      <div class="card-header">
        <a href="{{route('add.travel.view',['id'=>$travel_data[0]['user_id']])}}"><button type="button" class="btn btn-default">Add Travel</button></a>
        @else
        <a href="{{route('add.travel.view',['id'=>$user_id])}}"><button type="button" class="btn btn-default">Add Travel</button></a>
      </div>
      @endif
     <div class="card-body">
