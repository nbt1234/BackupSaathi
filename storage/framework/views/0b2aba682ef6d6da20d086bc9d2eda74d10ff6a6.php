                  ...
                  <tbody>                     
                    <?php $__currentLoopData = $parent_category_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent_category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                        ...
                        <td><?php echo e($parent_category->parent_name); ?></td>
                        <!-- <td><?php echo e($parent_category->parent_slug); ?></td> -->
                        <td><img src="<?php echo e(asset('/admin-assets/img/category_img/parent')); ?>/<?php echo e($parent_category->parent_icon); ?>"></td>
                        <td><?php echo e(ucfirst($parent_category->parent_status)); ?></td>                        
                        <td>
                            <a href="" class="edit_parentcat admin_edit_categories" cat_type="parent" cat_id="<?php echo e($parent_category->id); ?>" cat_name="<?php echo e($parent_category->parent_name); ?>" icon_path="<?php echo e(asset('/admin-assets/img/category_img/parent')); ?>" cat_icon="<?php echo e($parent_category->parent_icon); ?>" cat_status="<?php echo e($parent_category->parent_status); ?>">Edit</a>
...
<?php echo $__env->make('admin/index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u148312424/domains/urlsdemo.xyz/public_html/mypanel/resources/views/admin/category/parent-category-list.blade.php ENDPATH**/ ?>