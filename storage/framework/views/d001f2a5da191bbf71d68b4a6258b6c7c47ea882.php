      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo e('dashboard'); ?>" class="nav-link active">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e('add-subadmin'); ?>" class="nav-link">
...
</html><?php /**PATH C:\interviewapple\resources\views/admin/index.blade.php ENDPATH**/ ?>