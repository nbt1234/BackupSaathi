    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('allblogslist')); ?>" class="nav-link <?php echo e((Route::currentRouteName() == 'allblogslist') ? 'active' : ''); ?>">
              <i class="nav-icon fa fa-users"></i>
              <p>Blogs</p>
            </a>            
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('allpageslist')); ?>" class="nav-link <?php echo e((Route::currentRouteName() == 'allpageslist') ? 'active' : ''); ?>">
              <i class="nav-icon fa fa-users"></i>
              <p>Pages</p>
            </a>            
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('all.city')); ?>" class="nav-link <?php echo e((Route::currentRouteName() == 'all.city') ? 'active' : ''); ?>">
              <i class="nav-icon fa fa-users"></i>
              <p>City</p>
            </a>            
          </li>
...
</html><?php /**PATH C:\xampp\htdocs\saathi\resources\views/admin/index.blade.php ENDPATH**/ ?>