  ...
  margin-left:10px
    ...
    <div class="card-body">
        <form id="add_new_travel_form" action="<?php echo e(route('add.travel')); ?>" method="post" enctype="multipart/form-data">
            ...
            <?php echo csrf_field(); ?>
            <input type="hidden" name="user_id" class="form-control title" value ="<?php echo e($users); ?>">
            <div class="travelling_table_data">
                <div class="add col-md-12 row">
                    ...
                    <?php echo e($languages = DB::table('languages')->get()); ?>
                ...
                <div class="form-group col-md-4">
                    ...
                    <select name="airline_name" id="airlines_name" class="form-control">
                        ...
                        <?php $__currentLoopData = $airlines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $airline): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($airline->airlines_name); ?>"><?php echo e($airline->airlines_name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php echo $__env->make('admin/index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u148312424/domains/urlsdemo.xyz/public_html/saathi/resources/views/admin/travel-companion/add-travel.blade.php ENDPATH**/ ?>