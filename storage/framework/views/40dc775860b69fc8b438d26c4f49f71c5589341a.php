        ...
        <div class="input-group mb-3">
          <input type="email" name="email" class="form-control" placeholder="Email">
           <input type="password" name="password" class="form-control" placeholder="Password">
            <input type="password" name="password_confirmation" class="form-control" placeholder="Conform Password">
...
<?php /**PATH /home/u148312424/domains/urlsdemo.xyz/public_html/mypanel/resources/views/admin/auth/reset-password.blade.php ENDPATH**/ ?>