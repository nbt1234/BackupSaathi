    ...
    <div class="col-12">
      <div class="card">  
         <div class="card-header">
              <a href="<?php echo e(url('admin/user-add/')); ?>"><button type="button" class="btn btn-default" data-toggle="modal">Add User</button></a>
          </div>             
        <div class="card-body">
            ...
            <tbody>                     
              <?php $__currentLoopData = $users_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td><img src="<?php echo e(URL::asset('/admin-assets/img/profile_img/')); ?>/<?php echo e($user->user_avatar); ?>" alt="" height="60" width="60"></td>
                  <td><?php echo e($user->first_name); ?></td>
                  <td><?php echo e($user->last_name); ?></td>  
                  <td><?php echo e($user->email); ?></td>  
                  <td><?php echo e($user->phone); ?></td>  
                  <td><a href="<?php echo e(route('view.travel.list.byuser',$user->id)); ?>"><i class="fa fa-eye"></i></a></td>  
                  
                  <td>
                      
                      <a  href="<?php echo e(url('admin/view-user/'.$user->id)); ?>"><i class="fa fa-edit"></i></a>
                      <a  class="show_confirm" data-id ="<?php echo e($user->id); ?>"><i class="fa fa-trash"></i></a>
          ...
          var token = $("meta[name='csrf-token']").attr("content");
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              if (result.isConfirmed) {
                $.ajax({
                    type: 'post',
                    url: "<?php echo e(url('admin/user-destroy')); ?>",
                    data: {
                      "id": id,
                      "_token": token,
                    },
...
</html><?php /**PATH /home/u148312424/domains/urlsdemo.xyz/public_html/saathi/resources/views/admin/users/index.blade.php ENDPATH**/ ?>