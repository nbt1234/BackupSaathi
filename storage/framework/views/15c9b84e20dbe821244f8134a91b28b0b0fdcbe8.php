          ...
          <tbody>                 		
              <?php $__currentLoopData = $subadmin_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subadmin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td><a href="view-subadmin/<?php echo e($subadmin->id); ?>">Edit</a></td>
                </tr>							
...
<?php echo $__env->make('admin/index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\interviewapple\resources\views/admin/add-subadmin.blade.php ENDPATH**/ ?>