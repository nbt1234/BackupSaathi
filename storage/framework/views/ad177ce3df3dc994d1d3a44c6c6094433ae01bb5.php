  ...
  <div class="card card-outline card-primary"> 
    <div class="card-body">
      <p class="login-box-msg">Sign in</p>
	    ...
	    <form action="<?php echo e(url('/admin/user_login')); ?>" method="post">
	      	<?php echo csrf_field(); ?>
...
<?php /**PATH /home/u148312424/domains/urlsdemo.xyz/public_html/mypanel/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>